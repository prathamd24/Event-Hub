...
export default function RegisterCollegePage() {
    const [formData, setFormData] = useState({
        ...
        type: '', establishedYear: '', affiliation: '', contactEmail: '', naacGrade: '',
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-1">College Type</label>
                            <select name="type" value={formData.type} onChange={handleChange} className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2 text-white focus:ring-1 focus:ring-brand-500 appearance-none">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-1">University Affiliation</label>
                            <input name="affiliation" value={formData.affiliation} onChange={handleChange} className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2 text-white focus:ring-1 focus:ring-brand-500" placeholder="e.g. VTU, Anna University" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-1">Established Year</label>
                            <input type="number" name="establishedYear" value={formData.establishedYear} onChange={handleChange} min="1800" max={new Date().getFullYear()} className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2 text-white focus:ring-1 focus:ring-brand-500" placeholder="e.g. 1995" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-1">NAAC Grade</label>
                            <input name="naacGrade" value={formData.naacGrade} onChange={handleChange} className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2 text-white focus:ring-1 focus:ring-brand-500" placeholder="e.g. A++" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-1">Official Contact Email</label>
                            <input type="email" name="contactEmail" value={formData.contactEmail} onChange={handleChange} className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2 text-white focus:ring-1 focus:ring-brand-500" placeholder="info@college.edu" />
                        </div>
                        <div>
