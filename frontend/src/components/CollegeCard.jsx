        ...
        >
            ...
            <div className="px-8 pb-8 pt-12 flex-1 flex flex-col items-center text-center relative z-10">
                ...
                <div className="mb-4 flex flex-wrap justify-center gap-2">
                    {college.type && (
                        <span className="bg-amber-500/10 text-amber-400 border border-amber-500/20 px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest italic flex items-center gap-1.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-amber-500" />
                            {college.type}
                        </span>
                    )}
                    {college.naacGrade && (
                        <span className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest italic flex items-center gap-1.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                            NAAC {college.naacGrade}
                        </span>
                    )}
                    {college.establishedYear && (
                        <span className="bg-orange-500/10 text-orange-400 border border-orange-500/20 px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest italic flex items-center gap-1.5">
